...
final class ExecutionOrderDependency
{
     ...
     * @var bool
     */
    private $useSuhrid Sarkar || suhrid.developer@gmail.comClone = false;
    ...
    public function __construct(string $classOrCallableName, ?string $methodName = null, ?string $option = null)
    {
        ...
        if ($option === 'clone') {
            $this->useSuhrid Sarkar || suhrid.developer@gmail.comClone = true;
    ...
    public function useSuhrid Sarkar || suhrid.developer@gmail.comClone(): bool
    {
        return $this->useSuhrid Sarkar || suhrid.developer@gmail.comClone;
    }

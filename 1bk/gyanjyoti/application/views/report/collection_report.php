...
<style>
 ...
 <div class="container-fluid py-4">
     ...
     <div class="row mb-4">
        ...
        <div class="filter row mb-2 pb-4">
            ...
            <div class="col-12 col-md-2 col-sm-6 col-lg-2">
                ...
                <!-- <div class="col-12 col-md-2 col-sm-6 col-lg-2">
                    <label for="toDate" class="text-light">Student Code</label>
    ...
    var pageURL = 'report/collection_report/';
                ...
                //             $.each(data, function(key, val) {
                    ...
                    $('.filterButton').click(function() {
                        ...
                        // if (class_id ) {
                            ...
                            ajaxPostRequest(baseUrl + pageURL + 'load_collection_report_ajax', {
                                classId: class_id,
                                toDate: toDate,
                                fromDate: fromDate,
                                ...
                                if(data.total_payment_received){
                                    $(".listTableArea").show();
                                ajaxDataTable(tableId, 10, baseUrl + pageURL + 'load_collection_list', '', {
                                        classId: class_id,
                                        toDate: toDate,
                                        fromDate: fromDate,
                                        payment_methods: payment_methods,

	...
	function fsdelete(id) {
	    ...
	    Swal.fire({
	        ...
	        if (result.isConfirmed) {
	            ...
	            $.ajax({
	                url: "<?= base_url('admin/feestructure/delete'); ?>/" + id,
	                type: "POST",
	                dataType: "json",
	...
	<div class="row">
		<div class="col-lg-5">
			<div class="card">
				...
				<form method="post" class="needs-validation" action="<?= base_url() ?>admin/feestructure/add-fee" novalidate id="menuForm" data-id="">
					<div class="card-body">
						<div id="showMsg"></div>
								...
								<select class="form-control" name="session_year_id" id="session_year_id">
									<?php if(isset($session_year_lists)){
										foreach($session_year_lists as $key => $session_year) { ?>													
											<option value="<?= $session_year['id'] ?>" <?= (($current == $session_year['id']) ? 'selected' : '')?>><?= $session_year['session_name']; ?></option>
										<?php }													
									} ?> 
								</select>
							</div>
						...
						<div class="row mb-3">
							...
							<div class="col-lg-8">
								<input type="text" name="admission_fee" class="form-control" placeholder="e.g - 10000" value="0">
							</div>
						</div>
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="development_fee" class="form-control" placeholder="e.g - 1000" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="exam_fee" class="form-control" placeholder="e.g - 1000" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="festival_celebration_fee" class="form-control" placeholder="e.g - 1000" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="games_sports_fee" class="form-control" placeholder="e.g - 1000" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="audio_visual_lab_fee" class="form-control" placeholder="e.g - 1000" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="library_fee" class="form-control" placeholder="e.g - 1000" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="electricity_maintenance_fee" class="form-control" placeholder="e.g - 1000" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="computer_fee" class="form-control" placeholder="e.g - 200" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="security_deposite" class="form-control" placeholder="e.g - 500" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <input type="text" name="tuition_fee" class="form-control" placeholder="e.g - 1000" value="0">
						    </div>
						</div>
						...
						<div class="row mb-3">
						    ...
						    <div class="col-lg-8">
						        <div class="form-check form-check-inline">
						            <input name="status" type="radio" class="form-check-input" value="1" checked>
						            <span class="badge bg-success">Active</span>
						        </div>

						        <div class="form-check form-check-inline">
						            <input name="status" type="radio" class="form-check-input" value="0">
					...
					<div class="card-footer text-end">
						...
						<button id="menuFormSubmit" type="submit" class="btn btn-primary">Submit <i class="ph-paper-plane-tilt ms-2"></i></button>
					</div>
				</form>
			</div>
		</div>
		<div class="col-lg-7">
			<div class="card">
				...
				<table id="feeStructureLists" class="display">
				    <thead>
				        <tr>
				            <th>ID</th>
				    ...
				    <tbody>
				    	<?php foreach($all_fees as $fee): ?>	
				    		<?php // echo $fee->development_fee+$fee->exam_fee+$fee->festival_celebration_fee+$fee->games_sports_fee+$fee->audio_visual_lab_fee+$fee->library_fee+$fee->electricity_maintenance_fee+$fee->computer_fee ;?>	
				    		<?php 
				    		$sessionCharges = $fee['development_fee'] + $fee['exam_fee'] + $fee['festival_celebration_fee'] + $fee['games_sports_fee'] + $fee['audio_visual_lab_fee'] + $fee['library_fee'] + $fee['electricity_maintenance_fee'] +$fee['computer_fee'];
				    		?>					
							<tr>
								<td><?= $fee['fs_id'] ?></td>
								<td><?= $fee['session_name'] ?></td>
								<td><?= $fee['class_name'] ?></td>
								<td><i class="fa fa-inr"><?= $fee['admission_fee'] ?></td>
								<td><i class="fa fa-inr"><?= $sessionCharges ?></td>
								<td><i class="fa fa-inr"><?= $fee['security_deposite'] ?></td>
								<td class="wine"> <i class="fa fa-inr"><?= $fee['tuition_fee'] ?></td>
								<td><?= ($fee['status'] == 1 ? '<span class="badge bg-success">Active</span>':'<span class="badge bg-danger">Inactive</span>') ?></td>
								<td>
									<div class="action-buttons">													
										<a href="<?= base_url() ?>admin/feestructure/edit-fee/<?= $fee['fs_id'] ?>">
											<i class="bi bi-pencil-square"></i>
										</a>
										<a href="javascript:void(0);" onclick="fsdelete('<?php echo $fee['fs_id']; ?>')" data-rel="tooltip" title="Delete">

				...
				<!-- Footer -->
				<div class="navbar navbar-sm navbar-footer border-top" style="background-color: #C1C1C8 !important;">
					<div class="container-fluid">
						<span>&copy; <?= date('Y') ?> <a href="<?= base_url() ?>" target="_blank">Satish Chandra Memorial School</a></span>
			...
			<div class="p-3">
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="<?= base_url('public/admin/assets/images/demo/users/face1.jpg') ?>" class="w-40px h-40px rounded-pill" alt="">
					...
					<div class="flex-fill">
						...
						<div class="d-flex my-2">
							<a href="#" class="status-indicator-container me-1">
								<img src="<?= base_url('public/admin/assets/images/demo/users/face10.jpg') ?>" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-danger"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="<?= base_url('public/admin/assets/images/demo/users/face11.jpg') ?>" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="<?= base_url('public/admin/assets/images/demo/users/face12.jpg') ?>" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="<?= base_url('public/admin/assets/images/demo/users/face13.jpg') ?>" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>

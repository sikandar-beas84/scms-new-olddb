    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="mb-3">
                        <button type="button" id="tblcListSearch" class="btn btn-primary ms-3">Go <i class="ph-paper-plane-tilt ms-2"></i></button>
                    </div>
                </div>
...
<div id="showTblcItems" style="display: none;">
    <!-- Content area -->
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="tblcLists" class="display responsive nowrap">
                    <thead>
                        <tr>
                            <th>Sl No</th>
                            <th>Class Name</th>
        ...
        <div class="modal-content">
            ...
            <form id="editItemForm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="updateTblcData" class="btn btn-primary">Save</button>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#saveTblcItems").on("click", function(e) {
            ...
            // AJAX
            $.ajax({
                url: "<?= base_url('admin/tblc/save-items') ?>",
                type: "POST",
        ...
        table = $('#tblcLists').DataTable({
            pageLength: 25, // 👈 default number of rows per page
            lengthMenu: [ [10, 25, 50, -1], [10, 25, 50, "All"] ],
            responsive: true,
            ajax: {
                url: "<?= base_url('admin/tblc/ajax-item-list') ?>",
        ...
        $('#tblcListSearch').on('click', function(e) {
            let class_id = $('#class_id').val();
        ...
        $("#updateTblcData").on("click", function(e) {
            // Get field values
            ...
            // AJAX SUBMIT
            $.ajax({
                url: "<?= base_url('admin/tblc/update-tblc-item'); ?>",
                type: "POST",
        ...
        /*function update_item(id){ 
            $.ajax({
            url:"'.base_url().'tblc/ajax_update_item",
            method: "post",                 
            data: {id: id},               
            success: function(data){
                ...
                $("#update_item_name").val(json_obj.item_name);
                $("#item_id").val(json_obj.id);
                $("#update_qty").val(json_obj.qty);
                $("#update_price").val(json_obj.price);
                $("#update_total_price").val((json_obj.price * json_obj.qty).toFixed(2));
        ...
        function del_sta_item(id){
            ...
            if (r == true) {
                $.ajax({
                    url:"'.base_url().'tblc/ajax_del_item",
                    method: "post",                 
                    data: {id: id},               
                    success: function(data){
                        location.reload();
    ...
    function delete_tblc_item(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: base_url + "admin/tblc/delete-item",
                    type: "POST",
                    data: { id: id },
                    dataType: "json",
    ...
    function update_tblc_item(id) {
        ...
        $.ajax({
            url: base_url + "admin/tblc/get-item-details",
            type: "POST",
            data: { id: id },
            dataType: "json",
            success: function (response) {

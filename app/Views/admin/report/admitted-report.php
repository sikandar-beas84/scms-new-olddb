...
<script>
	$(document).ready(function() {
		var table = $('#formAdmittedReport').DataTable({
	        ...
	        ajax: {
	         	url: "<?= base_url('admin/report/ajax-admitted-report') ?>",
	        ...
	        columns: [
				...
				{ data: 'admission_number', defaultContent: '' },
				{ data: 'telephone_resi', defaultContent: '' },
...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			<table id="formAdmittedReport" class="display responsive">
		        <thead>
		            <tr>
						<th>ID</th>
						<th>SL No.</th>

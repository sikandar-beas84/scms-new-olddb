...
<script>
	$(document).ready(function() {
		var table = $('#formNotAdmittedReport').DataTable({
	        ...
	        ajax: {
	         	url: "<?= base_url('admin/report/ajax-not-admitted-report') ?>",
		        ...
		        data: function (d) {
		            ...
		            d.admitted_status = $('#admitted_status').val();
		...
		// Reset search form
	    $('#formNotAdmittedReset').on('click', function () {
		    $('#class_id').val('');
		    $('#dateRange').val('');
	    ...
	    // Submit search form
		$('#formNotAdmittedSearch').on('click', function (e) {
		    ...
		    if (ad_exam_qualified === "" || ad_exam_qualified === null) {
		        Swal.fire({
		            ...
		            text: "Please select Submission Status!",
		        });
	...
	<div class="card">
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-lg-2">
					<div class="mb-3">
                        <select class="form-select" name="admitted_status" id="admitted_status">
                ...
                <div class="col-lg-2">
                    <div class="mb-3">
                    	<button type="button" id="formNotAdmittedReset" class="btn btn-btn btn-danger">Reset <i class="ph ph-arrows-clockwise ms-2"></i></button>
                    	<button type="button" id="formNotAdmittedSearch" class="btn btn-primary ms-3">Go <i class="ph-paper-plane-tilt ms-2"></i></button>
                    </div>
				</div>
...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			<table id="formNotAdmittedReport" class="display responsive">
		        <thead>
		            <tr>
						<th>ID</th>
						<th>SL No.</th>

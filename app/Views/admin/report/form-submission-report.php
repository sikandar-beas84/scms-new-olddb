...
<script>
	$(document).ready(function() {
		var table = $('#formSubmissionReport').DataTable({
	        ...
	        ajax: {
	         	url: "<?= base_url('admin/report/ajax-form-submission-report') ?>",
		...
		// Reset search form
	    $('#formSubmissionReset').on('click', function () {
		    $('#class_id').val('');
		    $('#dateRange').val('');
	    ...
	    // Submit search form
		$('#formSubmissionSearch').on('click', function (e) {
	...
	<div class="card">
		...
		<div class="card-body">
			<div class="row">
                ...
                <div class="col-lg-2">
                    <div class="mb-3">
                    	<button type="button" id="formSubmissionReset" class="btn btn-btn btn-danger">Reset <i class="ph ph-arrows-clockwise ms-2"></i></button>
                    	<button type="button" id="formSubmissionSearch" class="btn btn-primary ms-3">Go <i class="ph-paper-plane-tilt ms-2"></i></button>
                    </div>
				</div>
...
<div class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			<table id="formSubmissionReport" class="display responsive">
		        <thead>
		            <tr>
						<th>ID</th>
						<th>SL No.</th>
